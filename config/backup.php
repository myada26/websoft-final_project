...
return [
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'keep_all_backups_for_days' => 7,         // FCATS: keep 7 daily backups (Section 5.1)
             ...
             */
            'keep_weekly_backups_for_weeks' => 4,     // FCATS: keep 4 weekly backups (Section 5.1)

            /*
             * After the "keep_weekly_backups_for_weeks" period is over, the most recent backup
             * of that month will be kept. Older backups within the same month will be removed.
             */
            'keep_monthly_backups_for_months' => 12,  // FCATS: keep 12 monthly backups (Section 5.1)
