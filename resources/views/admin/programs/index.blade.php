                    ...
                    <tr class="border-b border-[#eaf0ec] hover:bg-[#f0f3f1]/50 transition-colors last:border-b-0 group">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                ...
                                <form method="POST" action="{{ route('admin.programs.destroy', $prog) }}" data-confirm-message="Delete program {{ $prog->name }}?" data-confirm-label="Delete" data-confirm-tone="danger">
                                    @csrf @method('DELETE')
