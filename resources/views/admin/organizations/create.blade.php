                ...
                <form method="POST" action="{{ route('admin.organizations.store') }}">
                    ...
                    <div style="margin-bottom:16px">
                        ...
                        <select name="type" id="org-type" onchange="updateScopeFields(this.value)"
                            ...
                            <option value="SSC" {{ old('type') === 'SSC' ? 'selected' : '' }}>SSC — University-wide Council</option>
                            <option value="COLLEGE_COUNCIL" {{ old('type') === 'COLLEGE_COUNCIL' ? 'selected' : '' }}>COLLEGE_COUNCIL — College-level Council</option>
                            <option value="DEPT_SOCIETY" {{ old('type') === 'DEPT_SOCIETY' ? 'selected' : '' }}>DEPT_SOCIETY — Department Society</option>
                        </select>
                    ...
                    <div id="dept-field" style="margin-bottom:16px;display:{{ old('type') === 'DEPT_SOCIETY' ? 'block' : 'none' }}">
