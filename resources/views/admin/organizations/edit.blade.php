    ...
    <div style="max-width:600px">
        <div style="background:white;border-radius:12px;border:1px solid #dde8e1;box-shadow:0 1px 2px rgba(0,0,0,.06)">
            <div style="padding:16px 20px;border-bottom:1px solid #eaf0ec">
                <div style="font-size:15px;font-weight:700">Edit Organization</div>
                <div style="font-size:12px;color:#8aa89a;margin-top:2px">{{ $organization->name }}</div>
            </div>
            <div style="padding:24px">
                <form method="POST" action="{{ route('admin.organizations.update', $organization) }}">
                    ...
                    @php $currentType = old('type', $organization->type); @endphp
                    <div style="margin-bottom:16px">
