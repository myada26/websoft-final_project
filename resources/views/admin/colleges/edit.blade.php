    ...
    <div style="max-width:560px">
        <div style="background:white;border-radius:12px;border:1px solid #dde8e1;box-shadow:0 1px 2px rgba(0,0,0,.06)">
            <div style="padding:16px 20px;border-bottom:1px solid #eaf0ec">
                <div style="font-size:15px;font-weight:700">Edit College</div>
                <div style="font-size:12px;color:#8aa89a;margin-top:2px">Update college details</div>
            </div>
            <div style="padding:24px">
                <form method="POST" action="{{ route('admin.colleges.update', $college) }}">
                    ...
                    <div style="margin-bottom:16px">
                        ...
                        <input type="text" name="code" value="{{ old('code', $college->code) }}" maxlength="20"
