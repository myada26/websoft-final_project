...
<div class="max-w-6xl mx-auto pb-10">
    ...
    <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-6">
        <div>
            ...
            <p class="text-[13.5px] text-[#4a6356] mt-1 font-medium">Activity trail for {{ auth()->user()->organization?->name ?? 'your organization' }} · Read-only</p>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse min-w-[700px]">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="px-6 py-14 text-center text-[14px] font-semibold text-[#4a6356]">No log entries found</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
